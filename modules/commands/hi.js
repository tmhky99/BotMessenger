...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "hi.gif")) request("https://i.pinimg.com/originals/b3/6b/18/b36b18dcdfa5cd2cd062dd119f1aecb5.gif").pipe(fs.createWriteStream(dirMaterial + "hi.gif"));
}
